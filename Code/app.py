...
<p style="color: #111111; font-size: 14px; font-style:helvetica;"><i>Note: The site is still in testing phase and some Chromium browsers may block the display of the PDF. In that case Firefox would serve the purpose and work like a charm.<br>Inconvenience is deeply regretted.</p>""", unsafe_allow_html=True)

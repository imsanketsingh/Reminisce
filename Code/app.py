...
<p><i>Note: The site is still in testing phase and some browsers may block the display of the PDF. In that case Firefox would serve the purpose and serve like a charm.<br>Inconvenience is deeply regretted.</p>""", unsafe_allow_html=True)

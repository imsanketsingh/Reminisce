    ...
    if topic == "Books":
        ...
        with st.container():
            ...
            with text_col:
                ...
                st.markdown('The first article of the series "Rashmirathi" that explores this great epic by Ramdhari Singh Dinkar, delving into its philosophical and literary themes, offering insights into duty, morality, and the complexities of the Mahabharata character, Karna.', unsafe_allow_html=True)

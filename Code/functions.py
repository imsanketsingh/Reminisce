...
def displayMessage(title, message):
    ...
    with col1:
        ...
        st.markdown(f'<div style="text-align: center; position: relative; bottom: 10px; width: 100%;"> <span style="color: #767196; font-size: 33px; font-weight:Bold; font-style:helvetica;text-decoration: underline;">{title}</span> </div>', unsafe_allow_html=True)

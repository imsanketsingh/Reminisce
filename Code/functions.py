...
def specialSubtopics():
    return option_menu(None, ["Climate Change", "Guests"],
            ...
            styles={
                ...
                "nav-link": {"font-size": "16px", "text-align": "left", "margin": "10px", "padding": "8px", "border-radius": "6px", "transition": "background-color 0.3s ease", "color": "#333", "background-color": "#28a41d"},
                "nav-link-selected": {"background-color": "#28a40c", "color": "#fff"},
